...
# Move one piece.
def move_one_piece(state, old_x, old_y, new_x, new_y):
...
# Move two pieces.
def move_two_pieces(state, old_x1, old_y1, new_x1, new_y1,
...
# Move three pieces.
def move_three_pieces(state, old_x1, old_y1, new_x1, new_y1,
                      old_x2, old_y2, new_x2, new_y2,
...
# Move 2 to 1 sumito.
def move_2_to_1_sumito(state, old_x1, old_y1, new_x1, new_y1,
                       old_x2, old_y2, new_x2, new_y2):
...
def move_3_to_1_or_3_to_2_sumito(state, old_x1, old_y1, new_x1, new_y1,
                                 old_x2, old_y2, new_x2, new_y2,
                                 old_x3, old_y3, new_x3, new_y3):
    # Get the clicked position.
    ...
    # 1. 3 to 1 sumito.
    if ai_rules.generate_all_3_to_1_legal_sumitos(state, old_x1, old_y1, old_x2, old_y2, old_x3, old_y3) != set():
